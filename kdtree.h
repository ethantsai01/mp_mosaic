...
class KDTree
{
  ...
  public:
    ...
    int distance(const Point<Dim>& target, const Point<Dim>& input) const;
    /**
    ...
    KDTreeNode* build(vector<Point<Dim>>& newPoints, int left, int right, int dimension);
    Point<Dim> pick(vector<Point<Dim>>& newPoints, int left, int right, int k, int dimension);
    int part(vector<Point<Dim>>& newPoints, int left, int right, int pivot, int dimension);
    ...
    void copy(KDTreeNode*& current, KDTreeNode*& other);
    /**
    ...
    Point<Dim> findNearestNeighborHelper(const Point<Dim>& query, typename KDTree<Dim>::KDTreeNode* subRoot, int dimension) const;
